...
class CSS extends Minify
{
    ...
    protected function combineImports($source, $content, $parents)
    {
        ...
        // find all relative imports in js
        $matches = array();
    ...
    /**
     * Moving a js file should update all relative urls.
     * Relative references (e.g. ../images/image.gif) in a certain js file,
    ...
    protected function stripWhitespace($content)
    {
        ...
        // inspired by stackoverflow.com/questions/15195750/minify-compress-js-with-regex
