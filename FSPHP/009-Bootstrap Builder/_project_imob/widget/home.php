<div class="main_slide d-none d-md-block">
    <div class="container" style="height: 100%;">
        <div class="row align-items-center" style="height: 100%;">
            <div class="col-8">
                <p class="main_slide_content">
                    Encontre o <b>imóvel ideal</b> para você e <b>sua família</b> morar na praia!
                </p>
                <a href="#" class="btn btn-front btn-lg">Quero Alugar</a>
                <a href="#" class="btn btn-front btn-lg">Quero Comprar</a>
            </div>
        </div>
    </div>
</div>
...
<div class="main_filter">
    <div class="container my-5">
        <div class="">
            <form action="" class="row form-inline w-100">
                ...
                <div class="col-6 mt-3 d-flex justify-content-end">
                    <button class="btn btn-front text-white icon-search">Pesquisar</button>
...
<section class="main_list_group py-5 bg-light">
    <div class="container">
        <div class="border-bottom border-front p-4">
        ...
        <div class="main_list_group_items mt-5 d-flex justify-content-around row">
            <article class="col-12 col-md-6 col-lg-4 mb-4 main_list_group_items_item">
                <a href="#">
...
<section class="main_properties py-5">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center border-bottom border-front mb-5">
            ...
            <a href="#" class="text-front text-decoration-none">Ver mais</a>
        </div>
        ...
        <div class="row">
            <article class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="card main_properties_item">
                    ...
                    <div class="card-body">
                        <h2><a href="#" class="text-front text-decoration-none">Linda casa no Campeche com vista para o Mar</a></h2>
                        ...
                        <p class="main_properties_item_price text-front">R$ 400.000.000</p>
                        <a href="#" class="btn btn-front w-100 text-white">Ver Imóvel</a>
                    </div>
                    <div class="card-footer text-center d-flex text-body-secondary">
            ...
            <article class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="card main_properties_item">
                    <a href="#">
                        <img src="properties/2/1cd48888-1311-4280-bcc3-39109c7d1875.jpg" class="card-img-top" alt="...">
                    </a>
                    <div class="card-body">
                        <h2><a href="#" class="text-front text-decoration-none">Linda casa no Campeche com vista para o Mar</a></h2>
                        <p class="main_properties_item_category">Imóvel Residencial</p>
            ...
            <article class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="card main_properties_item">
                    <a href="#">
                        <img src="properties/3/667d07e1-c0ac-4e3b-b450-4bc9bcc9bffb.jpg" class="card-img-top" alt="...">
                    </a>
                    <div class="card-body">
                        <h2><a href="#" class="text-front text-decoration-none">Linda casa no Campeche com vista para o Mar</a></h2>
                        <p class="main_properties_item_category">Imóvel Residencial</p>
    ...
    <div class="container">
        ...
        <div class="row">
            <article class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="card main_properties_item">
                    <a href="#">
                        <img src="properties/4/3d656134-3760-4c9a-af1a-503301acc0be.jpg" class="card-img-top" alt="...">
                    </a>
                    <div class="card-body">
                        <h2><a href="#" class="text-front text-decoration-none">Linda casa no Campeche com vista para o Mar</a></h2>
                        <p class="main_properties_item_category">Imóvel Residencial</p>
                        <p class="main_properties_item_type">Apartamento - Campeche <i class="icon-location-arrow"></i></p>
                        <p class="main_properties_item_price text-front">R$ 4.000.000/Mês</p>
                        <a href="#" class="btn btn-front w-100 text-white">Ver Imóvel</a>
                    </div>
                    <div class="card-footer text-center d-flex text-body-secondary">
                        <div class="col-4 main_properties_item_features">
            ...
            <article class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="card main_properties_item">
                    <a href="#">
                        <img src="properties/5/743125d7-cfee-4fbf-92f9-f14cb4ac22ee.jpg" class="card-img-top" alt="...">
                    </a>
                    <div class="card-body">
                        <h2><a href="#" class="text-front text-decoration-none">Linda casa no Campeche com vista para o Mar</a></h2>
                        <p class="main_properties_item_category">Imóvel Residencial</p>
            ...
            <article class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="card main_properties_item">
                    <a href="#">
                        <img src="properties/5/eff27f5f-7342-4a86-9304-64d1fc5229bd.jpg" class="card-img-top" alt="...">
                    </a>
                    <div class="card-body">
                        <h2><a href="#" class="text-front text-decoration-none">Linda casa no Campeche com vista para o Mar</a></h2>
                        <p class="main_properties_item_category">Imóvel Residencial</p>
