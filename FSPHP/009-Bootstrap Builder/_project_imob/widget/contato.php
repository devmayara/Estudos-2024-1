<div class="main_contact py-5 bg-light text-center">
    <div class="container">
        ...
        <p class="mb-0">Quer conversar com um corretor exclusivo e ter o atendimento diferenciado em busca do seu imóvel dos sonhos?</p>
        ...
        <div class="row text-left">
            <form action="">
                ...
                <div class="form-group">
                    <input type="tel" class="form-control" placeholder="Insira seu telefone com DDD">
                </div>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-12 col-md-4">
                ...
                <p><a class="text-front pt-2" href="#">contato@upinside.com.br</a></p>
            </div>
            <div class="col-12 col-md-4">
                <h2 class="icon-phone">Por Telefone</h2>
                <p>Estamos disponíveis nos telefones abaixo no horário comercial.</p>
                <p class="text-front pt-2">+55 (11) 99999-9999</p>
            </div>
            <div class="col-12 col-md-4">
